...
public enum CreatureStatistic implements CreatureStatisticIf {
    // NECROPILIS FRACTION - BAD ALIGNED
    ...
    // CASTLE - GOOD ALIGNED
    PIKEMAN("Pikeman", 4, 5, 10, 1, Range.closed(1, 3), 1,
    ...
    CreatureStatistic(final String aName, final int aAttack, final int aArmor, final int aMaxHp,
                      ...
                      final boolean aIsUpgraded, final boolean aIsGoodAligned) {
        name = aName;
        attack = aAttack;
        armor = aArmor;
        maxHp = aMaxHp;
