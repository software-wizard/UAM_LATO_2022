...
public enum SpellStats implements SpellStatisticIf {
    ...
    CHAIN_LIGHTNING("Chain Lightning", AIR, "Fires a bolt of lightning at the selected\n unit which then travels to the nearest adjacent unit, inflicting half damage.", 24),
    COUNTERSTRIKE("Counterstrike", AIR, "The selected unit will retaliate against one\n additional attack each round.", 24),
    SLOW("Slow", EARTH, "Reduces the speed of the selected enemy unit.", 6),
    DEATH_RIPPLE("Death Ripple", EARTH, "Sends a wave of death across the battlefield\n which damages all non-undead units.", 10),
    ...
    METEOR_SHOWER("Meteor Shower", EARTH, "Causes a meteor shower to rain down on\n the selected target and any adjacent units.", 16),
    IMPLOSION("Implosion", EARTH, "Inflicts massive damage to a single creature stack", 30),
    FIRE_BALL("Fire Ball", FIRE, "Causes the selected target to burst into flames,\n inflicting fire damage to the target and any adjacent units.", 15),
    ...
    INFERNO("Inferno", FIRE, "Causes a huge blast of fire to strike the selected target.\n Don't be near this when it goes off!", 16),
    ...
    FROST_RING("Frost Ring", WATER, "Drains the body heat of any units adjacent to \nthe target location, without inflicting damage on the target.", 12),
