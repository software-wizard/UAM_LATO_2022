...
class EconomyEngineTest
{
    ...
    void init()
    {
        h1 = new EconomyHero( EconomyHero.Fraction.NECROPOLIS, Collections.emptyList(), 1000 );
        h2 = new EconomyHero( EconomyHero.Fraction.NECROPOLIS, Collections.emptyList(), 1000 );
